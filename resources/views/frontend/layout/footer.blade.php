                ...
                <div class="col-lg-7 mb-md-3 mb-lg-0">
                    <div class="row align-items-center">
                        <div class="col-auto flex-horizontal-center">
                            ...
                            <h2 class="font-size-20 mb-0 ml-3">Kampanya Bülteni</h2>
                        </div>
                        <div class="col my-4 my-md-0">
                            <h5 class="font-size-15 ml-4 mb-0">Bültenimize abone olun. İndirimlerden ilk siz haberdar olun</strong></h5>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5">
                ...
                <div class="col-lg-3">
                    ...
                    <div class="mb-4">
                        <div class="row no-gutters">
                            ...
                            <div class="col pl-3">
                                <div class="font-size-13 font-weight-light">7/24 Çağrı Merkezi Destek Hattı </div>
                                <a href="tel:+80080018588" class="font-size-20 text-gray-90">{{ config('settings.telefon1') }} </a>
                            </div>
                        </div>
                    </div>
                    <div class="mb-4">
