...
@section('customCSS')
    ...
    <script>
        ...
        fbq('init', '627987337861442');
        fbq('track', 'PageView');
    </script>
    <noscript><img height="1" width="1" style="display:none"  src="https://www.facebook.com/tr?id=627987337861442&ev=PageView&noscript=1"/></noscript>
