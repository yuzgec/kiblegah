        ...
        <td align="center" valign="top">
            ...
            <modules>
                ...
                <module label="em-01">
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#f0f3f8" data-bgcolor="BodyBg" data-module="Notification 5 module 1" data-thumb="http://www.freetemplates.bz/design/thumbnails/tellmail/05-1.png">
                        <tr>
                ...
                <module label="em-02">
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#f0f3f8" data-bgcolor="BodyBg" data-module="Notification 5 module 2" data-thumb="http://www.freetemplates.bz/design/thumbnails/tellmail/05-2.png">
                        <tr>
                            <td align="center" valign="top"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="main">
                                    <tr>
                                                                    ...
                                                                    <table border="0" align="left" cellpadding="0" cellspacing="0" class="full">
                                                                        <tr>
                                                                            <td align="center" valign="top"><a href="">
                                                                                <img mc:edit="tm5-01" editable label="image" src="https://kiblegahaileoyunlari.com.tr/assets/images/logo1.png" width="200"  alt=""/>
                                                                            </a></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                ...
                <module label="em-03">
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#f0f3f8" data-bgcolor="BodyBg" data-module="Notification 5 module 3" data-thumb="http://www.freetemplates.bz/design/thumbnails/tellmail/05-3.png">
                        <tr>
                            <td align="center" valign="top"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="main">
                                    <tr>
                                                                ...
                                                                <td width="125" align="left" valign="top" class="two-left"><table width="125" border="0" align="right" cellpadding="0" cellspacing="0" class="full">
                                                                        <tr>
                                                                            <td align="left" valign="top"><table width="125" border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="left" valign="top" style="font-family:'Open Sans', Verdana, Arial; font-size:30px; color:#FFF; font-weight:bold;" mc:edit="tm5-09"><multi label="content">{{ money($ShopCart->basket_total) }}₺</multi>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table></td>
                                                                        </tr>
                                                                ...
                                                                <td align="right" valign="top" class="two-left"><table border="0" align="right" cellpadding="0" cellspacing="0" class="full">
                                                                        <tr>
                                                                            <td align="left" valign="top"><table width="215" border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                    <tr>
                                                                                        <td width="100" align="left" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:14px; color:#71746f; line-height:22px; font-weight:bold;" class="two-left" mc:edit="tm5-26">
                ...
                <module label="em-09">
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#f0f3f8" data-bgcolor="BodyBg" data-module="Notification 5 module 9" data-thumb="http://www.freetemplates.bz/design/thumbnails/tellmail/05-9.png">
                        <tr>
                            <td align="center" valign="top"><table width="600" border="0" align="center" cellpadding="0" cellspacing="0" class="main">
                                    <tr>
                                        <td align="center" valign="top" style="background:#FFF;"><table width="500" border="0" cellspacing="0" cellpadding="0" class="two-left-inner">
                                                                ...
                                                                <td align="right" valign="top"><table border="0" align="right" cellpadding="0" cellspacing="0" class="full">
                                                                        <tr>
                                                                            <td align="left" valign="top"><table width="280" border="0" align="left" cellpadding="0" cellspacing="0">
                                                                                    <tr>
                                                                                        <td width="165" align="left" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:16px; color:#333; line-height:22px; font-weight:bold;" class="two-left" mc:edit="tm5-28">
                                                                                            <multi label="content">Genel Toplam</multi>
                                                                                        </td>
                                                                                        <td width="115" align="left" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:16px; color:#333; line-height:22px; font-weight:bold;" class="two-left" mc:edit="tm5-29">
                                                                                            <multi label="content">  {{ money($ShopCart->basket_total) }}₺</multi>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </td>
                ...
                <module label="em-11">
                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#f0f3f8" data-bgcolor="BodyBg" data-module="Notification 5 module 11" data-thumb="http://www.freetemplates.bz/design/thumbnails/tellmail/05-11.png">
                        <tr>
                                        ...
                                        <td align="center" valign="top"><table width="350" border="0" align="center" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:12px; color:#4b4b4c; line-height:30px; font-weight:bold; text-decoration:underline;" mc:edit="tm5-32">
                                                        <a href="https://www.kiblegah.com.tr" style="text-decoration:none; color:#4b4b4c;">kiblegah.com.tr</a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="center" valign="top" style="font-family:'Open Sans', sans-serif, Verdana; font-size:12px; color:#4b4b4c; line-height:30px; font-weight:bold; text-decoration:underline;" mc:edit="tm5-32">
